<h1>Mia Amalia - Berlatih Looping</h1>
    ...
    <?php
        ...
        /* 
            ...
            2 - I Love PHP
        */
        echo "<h4>Looping Ascending</h4>";
        for ($i = 2; $i <= 20; $i+=2) {// Looping Ascending
        echo $i . " - I Love PHP<br>";
        }

        echo "<h4>Looping Descending</h4>";
        for ($i = 20; $i >= 2; $i-=2) {// Looping Descending
        echo $i . " - I Love PHP<br>";
        }
...
// Lakukan Looping Di Sini
        ...
        */
        ...
        print_r($numbers);
        echo "<br>";
        echo "hasil sisa dari array angka";// Lakukan Looping di sini
        ...
        */
        ...
        // Mengubah array dimensi menjadi array asosiatif
        $associativeItems = array_map(function($item) {
        return array(
            'id' => $item[0],
            'name' => $item[1],
            'price' => $item[2],
