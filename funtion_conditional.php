...
<body>
<h1>Mia Amalia - Berlatih Function PHP</h1>
<?php
...
function greetings($name) {
    ...
    $nameCapitalized = ucfirst(strtolower($name));
    echo "Halo {$nameCapitalized}, Selamat Datang di Sanbercode!";
}
...
function palindrome($str) {
    // Menggunakan fungsi reverseString dari soal sebelumnya
